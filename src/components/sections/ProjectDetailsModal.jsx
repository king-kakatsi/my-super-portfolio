  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-6 right-6 w-10 h-10 flex items-center justify-center rounded-full bg-wine hover:bg-wine-dark shadow-lg shadow-wine/30 transition-all duration-300 z-10 group"
